package appui.pageObjectConfig;
...
public class PageObjectAutoCode {
	...
	static  String path="src/main/java/org/appui/pageObjectConfig/UILibrary.xml";
	public static void autoCode() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			sb.append("private String path=\"src/main/java/org/appui/pageObjectConfig/UILibrary.xml\";\n");
